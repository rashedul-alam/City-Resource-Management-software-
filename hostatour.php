<?php
    session_start();
    if(!isset($_SESSION['type']) || strtolower($_SESSION['type'])!='host')
    {
...
<header class="header_area" id="header">
                ...
                <div class="col-12 col-md-10">
                    ...
                    <div class="hero-search-form">
                        ...
                        <div class="nav nav-tabs" id="heroTab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-places-tab" data-toggle="tab" href="#nav-places" role="tab" aria-controls="nav-places" aria-selected="true">Hosting</a>
                            ...
                            <div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab">
                                ...
                                <div class="form_wrapper">
                                        ...
                                        <div class="title_container">
                                                <h2>Tour Host Form</h2>
                                                
                                            </div>
                                            
                                            <form class="hostatourform" action="hostatourvarification.php">
            <table>
                <tr>
                    <td><span>Select a place </span></td>
                    <td>
                ...
                <tr>
                    <td><span>Budget in BDT </span></td>
                    <td><input type="number" min="500" max="100000" name="budget" required></td>
                </tr>
                <tr>
                    <td>Gender requirements</td>
                    <td> 
                ...
                <tr>
                    <td><span>Minimum age </span></td>
                    <td><input type="number" min="18" max="100" name="minage" id='minage' oninput='validateAge()' required></td>
                </tr>
                <tr>
                    <td><span>Maximum age </span></td>
                    <td><input type="number" min="18" max="100" name="maxage" id='maxage' required></td>
                </tr>
                <tr>
                    <td><span>Minimum people </span></td>
                    <td><input type="number" min="5" max="100" name="minpeople" id='minpeople'oninput='validatePeople()' required></td>
                </tr>
                <tr>
                    <td><span>Maximum people </span></td>
                    <td><input type="number" min="5" max="100" name="maxpeople" id='maxpeople' required></td>
                </tr>
                <tr>
                    <td><span>Start date </span></td>
                    <td><input type="date" id='startdate' oninput='yourFunction()' min="<?php echo date('Y-m-d');?>" name="startdate" required></td>
                </tr>
                <tr>
                    <td><span>End date </span></td>
                    <td><input type="date" id ='enddate' min="<?php echo date('Y-m-d');?>" name="enddate" required></td>
                </tr>
                <tr>
                    <td><span>Tour plan </span></td>
                    <td><textarea name='tourplan' required></textarea></td>
                </tr>
                <tr>
                    <td colspan="2"><input type="submit" value="Host a tour"></td>
                </tr>
            </table>
        </form>
    </body>
    ...
    {
        var x = document.getElementById("minage").value;
        document.getElementById("maxage").setAttribute("min",x);
    }
    function validatePeople()
    {
        var x = document.getElementById("minpeople").value;
        document.getElementById("maxpeople").setAttribute("min",x);
    }
    </script>
                                            </div>
                                    </div>
