                        ...
                        <div class="collapse navbar-collapse" id="dorneNav">
                            <ul class="navbar-nav mr-auto" id="dorneMenu">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle"  href="deleteaccount.php" style="color:#ff00f7;font-weight: bold;font-weight: 900;" >Delete an account<span class="sr-only">(current)</span></a>
                                    
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="varifyarticle.php"  >Varify Article</a></li>
                ...
                <div class="col-12 col-md-10">
                    ...
                    <div class="hero-search-form">
                        ...
                        <div class="nav nav-tabs" id="heroTab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-places-tab" data-toggle="tab" href="#nav-places" role="tab" aria-controls="nav-places" aria-selected="true">Delete Account</a>
                                                ...
                                                <table >
                                                    <tr >
                                                                ...
                                                                <?php
															            ...
															            $sql = "SELECT * FROM ACCOUNT where type<>'admin'";
															            ...
															            while (($row = oci_fetch_assoc($result)) != false) 
															            {
															                    echo "<tr class='form_container'>
                                                                                    ...
                                                                                    <td> </td>
                                                                                    <td> </td>
                                                                                    <td style='padding: 15px;'><a class='button-custom' href='deletecrud.php?id=".$row['ID']."'>Delete</a></td> 
