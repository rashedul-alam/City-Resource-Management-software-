                        ...
                        <div class="collapse navbar-collapse" id="dorneNav">
                            <ul class="navbar-nav mr-auto" id="dorneMenu">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="articles.php"  >Articles</span></a>
                                    
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle"  href="myarticles.php" style="color:#ff00f7;font-weight: bold;font-weight: 900;">My Articles</a></li>
            ...
            if (mysqli_num_rows($result) > 0)
            {
                while($row = mysqli_fetch_assoc($result))
                {
                    if($_SESSION['id']==$row['userid'])
                    {
                        ...
                        echo '<form action="myarticlesedit.php">
            ...
            */
            ...
            while (($row = oci_fetch_assoc($s)) != false) 
            {
                ...
                echo '<div class="feature-events-content">';
                    ...
                    echo '<form action="myarticlesedit.php">
                    <input type="hidden" name="arid" value="'.$article.'">
                    <input type="submit" class="button-custom" value="Edit">
                    </form>';
